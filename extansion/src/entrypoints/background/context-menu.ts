...
export const MENU_ID_TRANSLATE = "qq-frog-translate"
export const MENU_ID_SELECTION_TRANSLATE = "qq-frog-selection-translate"
export const MENU_ID_SELECTION_CUSTOM_ACTION_PREFIX = "qq-frog-selection-custom-action:"
