...
export const TRANSLATE_PROVIDER_TYPES = ["google-translate", "microsoft-translate", "chrome-ai", "deeplx", "deepl", "openai", "deepseek", "google", "anthropic", "xai", "openai-compatible", "siliconflow", "bedrock", "groq", "deepinfra", "mistral", "togetherai", "cohere", "fireworks", "cerebras", "replicate", "perplexity", "vercel", "openrouter", "ollama", "volcengine", "minimax", "alibaba", "moonshotai", "huggingface"] as const satisfies Readonly<
  (keyof typeof LLM_PROVIDER_MODELS | typeof PURE_TRANSLATE_PROVIDERS[number] | typeof NON_API_TRANSLATE_PROVIDERS[number])[]
>
...
/** chrome-ai 判斷：使用 Chrome 內建 Gemini Nano (Prompt API) 的本地翻譯 */
export function isChromeAIProvider(provider: string): provider is "chrome-ai" {
  return provider === "chrome-ai"
}

export const LLM_PROVIDER_TYPES = ["openai", "deepseek", "google", "anthropic", "xai", "openai-compatible", "siliconflow", "bedrock", "groq", "deepinfra", "mistral", "togetherai", "cohere", "fireworks", "cerebras", "replicate", "perplexity", "vercel", "openrouter", "ollama", "volcengine", "minimax", "alibaba", "moonshotai", "huggingface"] as const satisfies Readonly<
...
export const CUSTOM_LLM_PROVIDER_TYPES = ["openai-compatible", "siliconflow", "volcengine"] as const satisfies Readonly<
  (keyof typeof LLM_PROVIDER_MODELS)[]
>
