...
export const testSeries: TestSeriesObject = {
  ...
  "config-with-non-llm-translate-provider": {
    description: "translate.providerId is a non-LLM provider; migration should pick first enabled LLM",
    config: {
      language: {
        sourceCode: "spa",
        targetCode: "eng",
  ...
  "config-with-llm-detection-enabled": {
    description: "LLM detection enabled; migration should set mode to llm",
    config: {
      language: {
        sourceCode: "jpn",
        targetCode: "eng",
