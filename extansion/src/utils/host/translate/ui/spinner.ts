...
export function createLightweightSpinner(ownerDoc: Document): HTMLElement {
  ...
  spinner.className = "qq-frog-spinner"
  ...
  spinner.style.cssText = `
    ...
    border-top: 1.5px solid var(--qq-frog-muted-foreground) !important;
  ...
  if (!prefersReducedMotion && spinner.animate) {
    ...
    spinner.style.borderTopColor = "var(--qq-frog-muted-foreground)"
  }
