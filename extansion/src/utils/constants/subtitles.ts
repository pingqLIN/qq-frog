...
// DOM IDs
export const TRANSLATE_BUTTON_CONTAINER_ID = "qq-frog-subtitles-translate-button-container"
export const HIDE_NATIVE_CAPTIONS_STYLE_ID = "qq-frog-hide-native-captions"

// Class names
export const SUBTITLES_VIEW_CLASS = "qq-frog-subtitles-view"
export const STATE_MESSAGE_CLASS = "qq-frog-subtitles-state-message"
export const TRANSLATE_BUTTON_CLASS = "qq-frog-subtitles-translate-button"
