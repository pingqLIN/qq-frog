...
PADDLE_RUNTIME_DIR = LOG_DIR / "paddle-runtime"
...
def build_child_environment(service_url: str) -> dict[str, str]:
    parsed = urllib.parse.urlparse(service_url)
    runtime_dir = PADDLE_RUNTIME_DIR
    ...
    child_env["FLAGS_log_dir"] = str(runtime_dir)
    child_env["GLOG_log_dir"] = str(runtime_dir)
    child_env["HOME"] = str(runtime_dir / "home")
    child_env["XDG_CACHE_HOME"] = str(runtime_dir / "xdg-cache")
    child_env["AISTUDIO_CACHE_HOME"] = str(runtime_dir / "aistudio-cache")
    child_env["TEMP"] = str(temp_dir)
    child_env["TMP"] = str(temp_dir)
    child_env["PADDLE_HOME"] = str(runtime_dir / "paddle-home")
    child_env["PADDLEOCR_HOME"] = str(runtime_dir / "paddleocr-home")
    child_env["PADDLE_PDX_HOME"] = str(runtime_dir / "paddlex-home")
    child_env["PADDLE_PDX_CACHE_HOME"] = str(runtime_dir / "paddlex-cache")
    return child_env
