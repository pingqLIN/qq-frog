...
def test_child_environment_binds_localhost_service_url_to_loopback():
    ...
    assert child_environment["FLAGS_log_dir"].endswith("bridge\\logs\\paddle-runtime")
    assert child_environment["GLOG_log_dir"].endswith("bridge\\logs\\paddle-runtime")
    assert child_environment["AISTUDIO_CACHE_HOME"].endswith("bridge\\logs\\paddle-runtime\\aistudio-cache")
    assert child_environment["PADDLE_PDX_CACHE_HOME"].endswith("bridge\\logs\\paddle-runtime\\paddlex-cache")
